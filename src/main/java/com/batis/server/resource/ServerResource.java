package com.batis.server.resource;

import com.batis.server.model.Response;
import com.batis.server.model.Server;
import com.batis.server.service.implementation.ServerServiceImpl;
...
public class ServerResource {
  ...
  public ResponseEntity<Response> deleteSever(@PathVariable("id") Long id) {
    return ResponseEntity.ok(
        Response.builder()
            .timeStamp(now())
